...
export default function Header() {
  ...
  return (
    <header role="banner" id="banner">
      <Link to="/" id="accueil">
        <img
          className="logo_entete"
          src="../../../Images/logo/logo_projet carnet.png"
          alt="maison en forme de C avec Casanote écrit dessus"
        />
      </Link>
      <nav className="menu_entete" role="menubar">
        ...
        <Link to="">
          <img
            src={notifimg}
            alt="clochette jaune avec un point d'interrogation"
          />
        </Link>
        <Link to="" onClick={handleSignOut}>
          <img
            src={logoutimg}
            alt="carré avec une flèche qui va sur la droite"
          />
          <p>Deconnexion</p>
        </Link>
      </nav>
