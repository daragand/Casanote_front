...
export default function UpdateHouse() {
  ...
  const selectedHouse = location.state?.selectedLogement;
  ...
  const [formData, setFormData] = useState({
    localisation: selectedHouse.localisation || {},
    piecesSurface: selectedHouse.piecesSurface || {},
    chauffage: selectedHouse.chauffage || {},
    dateEntree: selectedHouse.dateEntree || {},
  });
  ...
  const finalValidate = (data) => {
    ...
    axios
      .put(`${process.env.REACT_APP_DOMAIN}logement/ajout`, logement, {
